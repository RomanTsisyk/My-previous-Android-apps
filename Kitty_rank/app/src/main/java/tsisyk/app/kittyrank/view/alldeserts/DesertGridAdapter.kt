...
import tsisyk.app.kittyrank.R.anim.scale_xy
import tsisyk.app.kittyrank.R.anim.slide_from_top
import tsisyk.app.kittyrank.app.inflate
...
class DesertGridAdapter(private val deserts: MutableList<Desert>
    ...
    override fun getItemViewType(position: Int): Int {
        ...
        return if (desert.attributes.kitty_opinion == 500) ViewType.MANY_CALORIES.ordinal else ViewType.OTHER.ordinal
    }
